...
const sessionOptions = {//Associate pur sessions
    store,
    secret: process.env.SECRET,
    resave: false,
    saveUninitialized: true,
    cookie: {
        expires: Date.now() * 7 * 24 * 60 * 60 * 1000, //expire duration of our cookie
...
app.use(passport.initialize()); //it initialize a passport for every request
...
app.use((err, req, res, next) => { //custom Express middleware
